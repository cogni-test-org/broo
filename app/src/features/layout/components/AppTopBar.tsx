    ...
    <header className="flex h-16 w-full shrink-0 items-center justify-between border-b px-3 md:px-6">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <div className="hidden items-center gap-2 lg:flex">
          ...
          <a
            href="https://github.com/cogni-test-org/broo"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex h-10 items-center gap-2 rounded-md border border-border px-3 font-medium text-sm transition-colors hover:bg-accent hover:text-accent-foreground"
          >
